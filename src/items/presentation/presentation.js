  ...
  return (
    <div className="presentation-page">
      <div className="left-block">
        ...
        <div>
          <button className="btn-action custom-btn">{ translate('DOWNLOAD_CV') }</button>
          <button className="btn-action custom-btn">{ translate('CONTACT_MAIL') }</button>
          <button className="btn-action custom-btn">{ translate('LINKEDIN') }</button>
        </div>
      </div>
